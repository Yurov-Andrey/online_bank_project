...
@pytest.fixture
def test_fixture_transactions_for_generators_all_dict():
    return (
        [
            {
                "id": 939719570,
...
@pytest.fixture
def test_fixture_transactions_for_generators_invalid_currency():
    return (
        [
            {
                "id": 873106923,
...
@pytest.fixture
def test_fixture_transactions_for_generators_invalid_operation_amount_key():
    return (
        [
            {
                "id": 873106923,
...
@pytest.fixture
def test_fixture_transactions_for_generators_invalid_code():
    return {
        "id": 939719570,
        "state": "EXECUTED",
        "date": "2018-06-30T02:08:58.425572",
...
@pytest.fixture
def test_fixture_processing_json_dict_correct_list():
    return [
        {
            "id": 441945886,
            "state": "EXECUTED",
...
@pytest.fixture
def test_fixture_dict_conversion_usd():
    return {
        "id": 41428829,
        "state": "EXECUTED",
        "date": "2019-07-03T18:35:29.512364",
...
@pytest.fixture
def test_fixture_dict_conversion_rub():
    return {
        "id": 41428829,
        "state": "EXECUTED",
        "date": "2019-07-03T18:35:29.512364",
...
@pytest.fixture
def test_fixture_dict_conversion_invalid_oa():
    return {
        "id": 41428829,
        "state": "EXECUTED",
        "date": "2019-07-03T18:35:29.512364",
...
@pytest.fixture
def test_fixture_dict_conversion_invalid_amount():
    return {
        "id": 41428829,
        "state": "EXECUTED",
        "date": "2019-07-03T18:35:29.512364",
...
@pytest.fixture
def test_fixture_dict_conversion_invalid_currency():
    return {
        "id": 41428829,
        "state": "EXECUTED",
        "date": "2019-07-03T18:35:29.512364",
...
@pytest.fixture
def test_fixture_dict_conversion_invalid_sum():
    return {
        "id": 41428829,
        "state": "EXECUTED",
        "date": "2019-07-03T18:35:29.512364",
...
@pytest.fixture
def test_fixture_dict_conversion_invalid_code():
    return {
        "id": 41428829,
        "state": "EXECUTED",
        "date": "2019-07-03T18:35:29.512364",
...
@pytest.fixture
def test_fixture_dict_conversion_invalid_code_data():
    return {
        "id": 41428829,
        "state": "EXECUTED",
        "date": "2019-07-03T18:35:29.512364",
...
@pytest.fixture
def test_fixture_dict_conversion_invalid_type():
    return [{
        "id": 41428829,
        "state": "EXECUTED",
        "date": "2019-07-03T18:35:29.512364",
...
@pytest.fixture
def test_transaction_csv_imitation():
    return [
...
@pytest.fixture
def test_transaction_excel_imitation():
    return [
        ...
        {'id': 5380041.0, 'state': 'CANCELED', 'date': '2021-02-01T11:54:58Z', 'amount': 23789.0,
         'currency_name': 'Peso', 'currency_code': 'UYU', 'from': 'nan', 'to': 'Счет 23294994494356835683',
         'description': 'Открытие вклада'}]


@pytest.fixture
def test_fixture_dict_on_list_for_sort_func():
    return [
        {'id': '650703', 'state': 'EXECUTED', 'date': '2023-09-05T11:30:32Z', 'amount': '16210', 'currency_name': 'Sol',
         'currency_code': 'PEN', 'from': 'Счет 58803664561298323391', 'to': 'Счет 39745660563456619397',
         'description': 'Перевод организации'},
...
@pytest.fixture
def test_fixture_dict_on_list_for_sort_func_correct_result_card_to_card():
    return [
        {'id': '3598919', 'state': 'EXECUTED', 'date': '2020-12-06T23:00:58Z',
         'amount': '29740', 'currency_name': 'Peso', 'currency_code': 'COP',
         'from': 'Discover 3172601889670065', 'to': 'Discover 0720428384694643',
...
@pytest.fixture
def test_fixture_dict_on_list_for_sort_func_correct_result_money_transfer():
    return [
        {'id': '650703', 'state': 'EXECUTED', 'date': '2023-09-05T11:30:32Z', 'amount': '16210', 'currency_name': 'Sol',
         'currency_code': 'PEN', 'from': 'Счет 58803664561298323391', 'to': 'Счет 39745660563456619397',
         'description': 'Перевод организации'}
...
@pytest.fixture
def test_fixture_dict_on_list_for_sort_func_correct_result_deposit_open():
    return [
        {'id': '5380041',
         'state': 'CANCELED',
         'date': '2021-02-01T11:54:58Z',
...
@pytest.fixture
def test_fixture_category_list_for_sort_func():
    return ['Открытие вклада', 'Перевод с карты на карту', 'Перевод организации']
